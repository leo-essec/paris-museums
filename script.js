        ...
        <div style="text-align: center; margin-top: 2rem; padding: 1rem; background-color: #f8f9fa;"> 
            ...
            <p>Follow us on: 
                <a href="https://facebook.com" target="_blank" style="margin: 0 5px;">
                    <img src="https://img.icons8.com/color/48/facebook-new.png" alt="Facebook" style="width: 24px;">
                </a> 
                <a href="https://twitter.com" target="_blank" style="margin: 0 5px;">
                    <img src="https://img.icons8.com/color/48/twitter--v1.png" alt="Twitter" style="width: 24px;">
                </a> 
                <a href="https://instagram.com" target="_blank" style="margin: 0 5px;">
                    <img src="https://img.icons8.com/color/48/instagram-new--v1.png" alt="Instagram" style="width: 24px;">
                </a> 
            </p> 
        </div> 
        `; 
